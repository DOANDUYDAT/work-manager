...
import static group7.workmanager.graphics.View.cal;
import static group7.workmanager.graphics.View.user;
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        ...
        try {
            if (ResultUtils.rs.getString("account").equals(this.getUsername())){
                ...
                View.addImage(Infor.frame.getAvatar(), "images//bachkhoa.jpg");
        ...
        Infor.frame.getDate().setText("" + cal.get(Calendar.DATE) + "-" + (cal.get(Calendar.MONTH) + 1) + "-" + cal.get(Calendar.YEAR));
